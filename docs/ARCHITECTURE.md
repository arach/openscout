...
2. Move the first collaboration workflow primitives into Scout-owned modules under `apps/scout` or shared runtime/protocol packages, rather than reviving any old workflow package, starting
