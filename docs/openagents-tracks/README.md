...
- [packages/relay/docs/architecture.md](/Users/arach/dev/openscout/packages/relay/docs/architecture.md)
...
- [native/engine/Sources/ScoutApp](/Users/arach/dev/openscout/native/engine/Sources/ScoutApp)
