// PlexusCompactKeyboard — UIKit QWERTY keyboard ported from Talkie's CompactKeyboardView.
//
...
// MARK: - PlexusCompactKeyboard

final class PlexusCompactKeyboard: UIView {

    // MARK: - Colors (dark-first, Plexus adapted)
    ...
    private func setupUI() {
        ...
        registerForTraitChanges([UITraitUserInterfaceStyle.self]) { (self: PlexusCompactKeyboard, prev: UITraitCollection) in
...
/// SwiftUI wrapper for the UIKit-based PlexusCompactKeyboard.
struct PlexusCompactKeyboardView: UIViewRepresentable {
    var onInsert: (String) -> Void
    var onDelete: () -> Void
    var onReturn: () -> Void
    var onVoice: () -> Void

    func makeUIView(context: Context) -> PlexusCompactKeyboard {
    ...
    func updateUIView(_ uiView: PlexusCompactKeyboard, context: Context) {
