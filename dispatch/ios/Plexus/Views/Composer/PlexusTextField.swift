// PlexusTextField — Editable text view that suppresses the native keyboard.
//
...
struct PlexusTextField: UIViewRepresentable {
    ...
    private func updateColors(_ textView: UITextView) {
        textView.textColor = UIColor(PlexusColors.textPrimary)
        textView.tintColor = UIColor(PlexusColors.accent)
    }
    ...
    private func makePlaceholderLabel() -> UILabel {
        ...
        label.textColor = UIColor(PlexusColors.textMuted)
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        let parent: PlexusTextField
        var placeholderLabel: UILabel?

        init(parent: PlexusTextField) {
            self.parent = parent
        }
