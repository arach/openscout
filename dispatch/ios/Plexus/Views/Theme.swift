// Theme — Shared design tokens for the Plexus iOS client.
//
...
struct PlexusCardModifier: ViewModifier {
    var padding: CGFloat = PlexusSpacing.md
    var cornerRadius: CGFloat = PlexusRadius.md
...
extension View {
    func plexusCard(padding: CGFloat = PlexusSpacing.md,
                    cornerRadius: CGFloat = PlexusRadius.md) -> some View {
        modifier(PlexusCardModifier(padding: padding, cornerRadius: cornerRadius))
    }
}
...
struct StatusDot: View {
    ...
    var color: Color {
        switch status {
        case .active: PlexusColors.statusActive
        case .connecting: PlexusColors.statusStreaming
        case .idle: PlexusColors.statusIdle
        case .error: PlexusColors.statusError
        case .closed: PlexusColors.statusIdle
        }
    }
...
struct PulseIndicator: View {
    ...
    var body: some View {
        Circle()
            .fill(PlexusColors.accent.opacity(0.8))
