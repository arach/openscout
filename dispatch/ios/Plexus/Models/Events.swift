...
struct SequencedEvent: Codable, Sendable {
    let seq: Int
    let event: PlexusEvent
}

// MARK: - PlexusEvent — discriminated union on "event" field

enum PlexusEvent: Sendable {
