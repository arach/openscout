...
// collects their Dispatch events, and exposes a single WebSocket endpoint for
...
export class Bridge {
  ...
  async closeSession(sessionId: string): Promise<void> {
    ...
    const closedEvent: DispatchEvent = { event: "session:closed", sessionId };
  ...
  /** Subscribe to all Dispatch events from all sessions (receives SequencedEvents). */
  ...
  private broadcast(event: DispatchEvent): void {
