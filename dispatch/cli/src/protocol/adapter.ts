...
// Dispatch.  An adapter wraps one agent (Claude Code, Codex, Gemini, a browser
// extension, etc.) and translates its native events into Dispatch primitives.
//
...
export interface Adapter {
  ...
  on(event: "event", listener: (e: DispatchEvent) => void): void;
  on(event: "error", listener: (e: Error) => void): void;

  off(event: "event", listener: (e: DispatchEvent) => void): void;
...
export abstract class BaseAdapter implements Adapter {
  ...
  private eventListeners = new Set<(e: DispatchEvent) => void>();
  ...
  protected emit(event: "event", payload: DispatchEvent): void;
