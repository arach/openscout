...
export default {
  ...
  agent: {
    ...
    rules: [
      ...
      { pattern: 'agent identity', instruction: 'See the Agent Identity And Addressing section of docs/architecture.md for address grammar' },
      ...
      { pattern: 'collaboration', instruction: 'See docs/agents-and-collaboration.md' },
      { pattern: 'data ownership', instruction: 'See the Data Model section of docs/architecture.md before persisting harness transcript data' },
