...
} from "../../../../apps/scout/src/app/desktop/state.ts";
import type {
  ScoutPairingSnapshot,
  ScoutPairingState,
  UpdateScoutPairingConfigInput,
} from "../../../../apps/scout/src/app/electron/pairing.ts";
import type {
  AppSettingsState,
...
} from "../../../../apps/scout/src/app/electron/settings.ts";
import type {
  ScoutElectronAgentConfigState,
  ScoutElectronUpdateAgentConfigInput,
} from "../../../../apps/scout/src/app/electron/agent-config.ts";
import type {
...
} from "../../../../apps/scout/src/app/electron/diagnostics.ts";
import type { ScoutElectronAgentSessionInspector } from "../../../../apps/scout/src/app/electron/agent-session.ts";
import type {
  ScoutElectronBrokerControlAction,
  ScoutElectronRestartAgentInput,
  ScoutElectronSendRelayMessageInput,
} from "../../../../apps/scout/src/app/electron/broker-actions.ts";
