...
public struct NoiseKeyPair: Sendable {
    ...
    public init(publicKey: Data, privateKey: Curve25519.KeyAgreement.PrivateKey) {
...
public enum HandshakePattern: String, Sendable {
    case XX
    case IK
}
...
public func generateNoiseKeyPair() -> NoiseKeyPair {
...
public func noiseKeyPairFrom(privateKeyData: Data) throws -> NoiseKeyPair {
...
public final class NoiseHandshake: @unchecked Sendable {
    ...
    public func finalize() throws -> NoiseSession {
