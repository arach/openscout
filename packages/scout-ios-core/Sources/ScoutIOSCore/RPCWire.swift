...
let trpcRouteMap: [String: TRPCRoute] = [
    ...
    "codex/deck/snapshot":     TRPCRoute(path: "codexDeck.snapshot",     method: .query),
    "codex/deck/connect":      TRPCRoute(path: "codexDeck.connect",      method: .mutation),
    "codex/deck/start":        TRPCRoute(path: "codexDeck.start",        method: .mutation),
    "codex/deck/steer":        TRPCRoute(path: "codexDeck.steer",        method: .mutation),
    "codex/deck/interrupt":    TRPCRoute(path: "codexDeck.interrupt",    method: .mutation),
