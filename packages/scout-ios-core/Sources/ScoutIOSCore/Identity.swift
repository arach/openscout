...
public struct TrustedBridge: Codable, Sendable, Identifiable {
    public let publicKey: Data      // 32 bytes (raw X25519 public key)
    ...
    public init(publicKey: Data, name: String?, pairedAt: Date, lastSeen: Date?) {
...
public final class ScoutIdentity: Sendable {
    ...
    private static let service = "app.openscout.scout.identity"
    ...
    public static func saveOSNSessionToken(_ token: String) throws {
    ...
    public static func saveTrustedBridge(publicKey: Data, name: String? = nil) throws {
    ...
    public static func isTrustedBridge(publicKey: Data) -> Bool {
    ...
    public static func removeTrustedBridge(publicKey: Data) throws {
        var bridges = try getTrustedBridges()
