...
/** Cloud blossom enclosing a `>_` terminal prompt — OpenAI / Codex.
 *  Cloud outline is 11 semicircle bumps; verified in design/studio
 *  (/studies/agent-lanes-card) before porting here. */
const openaiGlyph = (
  <g fill="none" stroke="currentColor" strokeLinejoin="round" strokeLinecap="round">
    <path
      strokeWidth={1.5}
      d="M12 5.4A1.86 1.86 0 0 1 15.57 6.45A1.86 1.86 0 0 1 18 9.26A1.86 1.86 0 0 1 18.53 12.94A1.86 1.86 0 0 1 16.99 16.32A1.86 1.86 0 0 1 13.86 18.33A1.86 1.86 0 0 1 10.14 18.33A1.86 1.86 0 0 1 7.01 16.32A1.86 1.86 0 0 1 5.47 12.94A1.86 1.86 0 0 1 6 9.26A1.86 1.86 0 0 1 8.43 6.45A1.86 1.86 0 0 1 12 5.4Z"
    />
    <path strokeWidth={1.9} d="M9.6 9.4 12.7 12 9.6 14.6" />
    <path strokeWidth={1.9} d="M13.7 14.6H16.3" />
  </g>
);
