...
//
// Pairing previously carried a second Codex app-server implementation here.
...
//
// Instead of maintaining two app-server clients, Pairing now reuses the
// runtime's Codex harness and maps its final response back into Pairing
// turn/block events.
