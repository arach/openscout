...
const scoutDesktop = {
  ...
  refreshSettingsInventory: () => ipcRenderer.invoke(SCOUT_CHANNELS.refreshSettingsInventory),
  ...
  reloadApp: () => ipcRenderer.invoke(SCOUT_CHANNELS.reloadApp),
  ...
  getKeepAliveState: () => ipcRenderer.invoke(SCOUT_CHANNELS.getKeepAliveState),
  acquireKeepAliveLease: (input) => ipcRenderer.invoke(SCOUT_CHANNELS.acquireKeepAliveLease, input),
