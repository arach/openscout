...
/// App-level state for ScoutNext: the fleet of encrypted bridge clients, the
...
final class AppModel {
    ...
    var terminalSSHHost: String? {
        ...
        switch route {
        case .lan, .tailnet, .oscout, .loopback: return fleet.focusedClient.currentHost
...
@MainActor
private final class FleetConnectionManager {
