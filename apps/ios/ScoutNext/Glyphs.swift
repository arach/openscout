...
struct GlyphShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        case .comms:
            // Two overlapping speech bubbles, each with a short tail.
            p.addRoundedRect(in: box(2.5, 3, 15, 12, 2.4), cornerSize: .init(width: 2.4 * s, height: 2.4 * s))
            p.move(to: P(6, 12)); p.addLine(to: P(5.2, 15.4)); p.addLine(to: P(9.2, 12))
            p.addRoundedRect(in: box(9, 9.5, 21.5, 18.5, 2.4), cornerSize: .init(width: 2.4 * s, height: 2.4 * s))
            p.move(to: P(18, 18.5)); p.addLine(to: P(18.8, 21.9)); p.addLine(to: P(14.8, 18.5))
