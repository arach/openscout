...
const API_ROUTES: Record<string, { method: "GET" | "POST"; path: string | ((args: unknown[]) => string) }> = {
  ...
  "scout:get-relay-shell-patch":   { method: "GET",  path: "/api/relay-shell-patch" },
  "scout:get-shell-state":         { method: "GET",  path: "/api/shell-state" },
  "scout:refresh-relay-shell-patch": { method: "GET", path: "/api/relay-shell-patch/refresh" },
  ...
  "scout:answer-pairing-question": { method: "POST", path: "/api/pairing/question-answer" },
  ...
  "scout:answer-agent-session-question": { method: "POST", path: "/api/agent-session/question-answer" },
