...
import { copyTextToClipboard } from "@/components/relay/relay-timeline";
import {
  asErrorMessage,
  compareAgentRoster,
...
import type { AgentRosterFilterMode, AgentRosterSortMode } from "@/components/relay/relay-types";
...
export function useAgentController({
  ...
  }, [handleSelectInterAgent, setActiveView, setSettingsSection]);
  ...
  }, [selectedInterAgentId, setActiveView, setSettingsSection]);
