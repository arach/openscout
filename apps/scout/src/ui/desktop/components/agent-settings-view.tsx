      ...
      <div className="space-y-4 min-w-0">
        <section className="border rounded-xl p-5" style={{ ...styles.surface, borderColor: C.border }}>
          ...
          <div className="text-[12px] mt-2 leading-[1.6]" style={styles.mutedText}>
            Agent configuration lives here now. Pick an agent from the list below to edit its runtime, tools, and capabilities.
          </div>
        </section>

        <section className="border rounded-xl p-3" style={{ ...styles.surface, borderColor: C.border }}>
          <div className="text-[10px] font-mono tracking-widest uppercase px-2 pt-2 mb-2" style={{ color: C.accent }}>
            Agent List
          </div>
            ...
            {availableAgents.length > 0 ? availableAgents.map((agent) => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-[9px] font-mono uppercase px-1.5 py-0.5 rounded shrink-0" style={agent.state === "working" ? styles.activePill : styles.tagBadge}>
