...
public enum OpenScoutResolutionSource: String {
    case env
    case path
...
public enum OpenScoutJavaScriptRuntimeKind: String {
    case bun
    case node
}

public struct OpenScoutResolvedExecutable {
    public let url: URL
    public let source: OpenScoutResolutionSource

    public init(url: URL, source: OpenScoutResolutionSource) {
        self.url = url
        self.source = source
    }
}

public struct OpenScoutResolvedJavaScriptRuntime {
    public let executable: OpenScoutResolvedExecutable
    public let kind: OpenScoutJavaScriptRuntimeKind
...
public struct OpenScoutPathResolver {
    ...
    public func resolveBunExecutable() -> OpenScoutResolvedExecutable? {
        resolveExecutable(
    ...
    public func resolveJavaScriptRuntime(
    ...
    public func resolveRepoRoot() -> URL? {
    ...
    public func resolveRepoEntrypoint(relativePath: String) -> URL? {
    ...
    public func resolvePath(fromEnvironmentKey key: String) -> URL? {
    ...
    public func expandPath(_ value: String) -> URL {
        if value == "~" {
