...
public enum PairingControlAction {
    case start
    case stop
    case restart
}
...
public final class PairingService {
    ...
    public func loadState() async -> PairingViewState {
        clearStaleArtifacts()
    ...
    public func control(_ action: PairingControlAction) async throws -> PairingViewState {
        switch action {
        case .start:
