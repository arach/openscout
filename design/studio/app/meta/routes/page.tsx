...
const PAGES: PageInventory[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      route("/providers", "Providers", "canonical", "Ops subnav and Home gauges"),
      route("/harnesses", "Providers alias", "parser", "Legacy deep links"),
...
const COMPONENTS: ComponentInventory[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      route("/providers", "Providers", "ui", "OPS_SECONDARY_NAV"),
  ...
  },
  {
    ...
    routes: [
      ...
      route("/providers", "Open providers", "ui", "HomeHero"),
