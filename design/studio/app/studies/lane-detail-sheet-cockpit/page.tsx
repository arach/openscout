...
.now-label{font-family:ui-monospace,monospace;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.16em;
  color:color-mix(in srgb,${C.green} 78%,${C.ink})}
.now-turn{margin-left:auto;font-family:ui-monospace,monospace;font-size:9.5px;color:${C.dim}}
...
.now-prompt{flex:none;color:color-mix(in srgb,${C.green} 85%,${C.muted});font-weight:700;font-family:ui-monospace,monospace;font-size:12px;line-height:1.5}
...
.gauge-label{font-family:ui-monospace,monospace;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.16em;color:${C.muted}}
.gauge-read{margin-left:auto;font-family:ui-monospace,monospace;font-size:11px;color:${C.dim};display:inline-flex;align-items:baseline;gap:0}
.gauge-read b{color:${C.ink};font-weight:600;font-size:13.5px;font-variant-numeric:tabular-nums}
.gauge-of{color:${C.dim}}
.gauge-unit{color:${C.faint};margin-left:4px}
.gauge-pct{margin-left:9px;padding:1px 6px;border-radius:9px;font-size:9.5px;font-weight:600;
...
.cadence-read{font-family:ui-monospace,monospace;font-size:10px;color:${C.dim}}
...
.dial-n{font-family:ui-monospace,monospace;font-size:11.5px;color:${C.muted};font-variant-numeric:tabular-nums;
  white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.dial-l{font-family:ui-monospace,monospace;font-size:8.5px;color:${C.faint};text-transform:lowercase;letter-spacing:.06em}
